...
\begin{itemize}
 \item Resultados medianamente consistentes y competitivos: únicamente las variantes que implementan el operador de recombinación en espacios particionados (QIEA$\mathbb{R}$-pCO y UQIEA$\mathbb{R}$-pCO), logrando obtener resultados mejores que los algoritmos originales cuando el número de individuos clásicos generados por individuo cuántico por iteración es más bajo.
...
\begin{itemize}
 ...
 \item En los casos en los que un algoritmo con espacios de búsqueda segregados por individuo cuántico destaca -UQIEA$\mathbb{R}$-pCO es un buen ejemplo de este caso-, parece ser más influencia del propio operador de recombinación que de la segregación propiamente dicha.
\end{itemize}
\end{frame}
...
\frametitle{Problemas}
\begin{itemize}
 \item Las pruebas en funciones con mínimos ubicados cercanos en los extremos de los espacios de búsqueda también han representado un reto que no se pudo asumir, debido a la inexistencia de una metodología apropiada para la delimitación de la expansión en el espacio de búsqueda del algoritmo original.

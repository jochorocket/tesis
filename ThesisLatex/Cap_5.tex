...
Las características inherentes al algoritmo mencionadas en la Sección 3.3 seleccionadas para ejecutar en las pruebas son:

\begin{itemize}
 \item Estrategia$(\mu +\lambda)$-EE para la selección de la nueva población clásica.
